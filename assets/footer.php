<footer class="relative z-10 pt-[120px]">
      <div class="container">
        <div class="flex flex-wrap -mx-4">
          <div class="w-full px-4 md:w-1/2 lg:w-4/12 xl:w-4/12">
            <div
              class="wow fadeInUp mb-14 max-w-[330px] xl:mb-20"
              data-wow-delay="0s"
            >
              ...
              <p
                class="mb-10 text-base font-medium text-body-color-2 dark:text-body-color"
              >
                We are a company dedicated to providing exceptional services and innovative solutions to our clients.
              </p>
          ...
          <div class="w-full px-4 sm:w-1/2 md:w-1/2 lg:w-4/12 xl:w-2/12">
            <div class="wow fadeInUp mb-14 xl:mb-20" data-wow-delay="0s">
              ...
              <div class="space-y-3">
                <a
                  href="javascript:void(0)"
                  class="block text-base font-medium text-body-color-2 hover:text-primary dark:text-body-color dark:hover:text-primary"
                >
                  What is ico
                </a>
                <a
        ...
        <div
          class="wow fadeInUp border-t border-[#F3F4F4] py-7 text-center dark:border-[#2D2C4A]"
          data-wow-delay="0s"
        >
          <p
    ...
    <script>
      ...
      // Function to handle scroll and update menu highlights
      function onScroll() {
        ...
        sections.forEach((currLink) => {
          ...
          currLink.classList.remove("dark:text-white", "text-primary");

          // Add appropriate active class if section is active
          if (isActive) {
            const isDarkMode =
              document.documentElement.classList.contains("dark");
            currLink.classList.add(
              isDarkMode ? "dark:text-white" : "text-primary"
            );
          }
        });
      }
      ...
      document.addEventListener("DOMContentLoaded", function () {
        ...
        const isDarkMode = applySavedTheme();
        ...
        if (darkModeToggle) {
          ...
          darkModeToggle.addEventListener("change", function () {
            ...
            onScroll(); // Update menu highlights
          });
        }
      ...
      (function () {
        function c() {
          ...
          if (b) {
            ...
            d.innerHTML =
              "window.__CF$cv$params={r:'9570da3efae8385a',t:'MTc1MTE1MjE3My4wMDAwMDA='};var a=document.createElement('script');a.nonce='';a.src='cdn-cgi/challenge-platform/h/b/scripts/jsd/07af8245c728/maind41d.js';document.getElementsByTagName('head')[0].appendChild(a);";
    ...
    <script
      ...
      data-cf-beacon='{"rayId":"9570da3efae8385a","version":"2025.6.2","r":1,"serverTiming":{"name":{"cfExtPri":true,"cfEdge":true,"cfOrigin":true,"cfL4":true,"cfSpeedBrain":true,"cfCacheStatus":true}},"token":"9a6015d415bb4773a0bff22543062d3b","b":1}'
