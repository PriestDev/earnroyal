...
<head>
    ...
    <title> Bluewave ISO - Balance Transfer</title>
    <meta name="title" Content="Bluewave ISO - Balance Transfer">
    ...
    <meta name="apple-mobile-web-app-title" content="Bluewave ISO - Balance Transfer">
    
    <meta itemprop="name" content="Bluewave ISO - Balance Transfer">
    ...
    <meta property="og:url" content="https://bluewave-iso.net/user/transfer-balance">
...
<div class="d-flex flex-wrap">
    ...
    <li>
        ...
        <li>
        <a href="https://bluewave-iso.net/user/transfer-balance" class="active">
            <svg class="menu-icon" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  filter: invert(1) hue-rotate(180deg);
        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="method-header mb-4">
                    <h3 class="method-title mb-2">Transfer Balance</h3>
                    <p class="method-subtitle">You can transfer the balance to another user from both of your wallets. The transferred amount will be added to the deposit wallet of the targeted user.</p>
                </div>
                <div class="card custom--card">
                    <form action="" method="post" enctype="multipart/form-data">
                        <input type="hidden" name="_token" value="Rl6nikVoa3o45jTzwrKb4seoP72kc3Hi1l3rVgq9">                        <div class="card-body">
                            ...
                            <div class="form-group">
                                <label>Amount <small class="text--success">(Charge: 5 USD + 1%)</small></label>
    ...
    <script src="https://bluewave-iso.net/assets/templates/invester/js/main.js"></script>
        ...
        $('input[name=amount]').on('input', function() {
            ...
            var calculation = amo + (parseFloat(5.00000000) + (amo * parseFloat(1.00)) / 100);
            if (calculation) {
        ...
        $('.findUser').on('focusout', function(e) {
            var url = 'https://bluewave-iso.net/user/find-user';
            var value = $(this).val();
            var token = 'Rl6nikVoa3o45jTzwrKb4seoP72kc3Hi1l3rVgq9';
