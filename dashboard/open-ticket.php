...
<head>
    ...
    <title> Bluewave ISO - Open Ticket</title>
    <meta name="title" Content="Bluewave ISO - Open Ticket">
    ...
    <meta name="apple-mobile-web-app-title" content="Bluewave ISO - Open Ticket">
    
    <meta itemprop="name" content="Bluewave ISO - Open Ticket">
    ...
    <meta property="og:url" content="https://bluewave-iso.net/ticket/new">
...
<div class="d-flex flex-wrap">
    ...
    <li>
        ...
        <li>
        <a href="https://bluewave-iso.net/ticket" class="active">
            <svg class="menu-icon" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  filter: invert(1) hue-rotate(180deg);
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        <form action="https://bluewave-iso.net/ticket/create" method="post" enctype="multipart/form-data">
                            <input type="hidden" name="_token" value="Rl6nikVoa3o45jTzwrKb4seoP72kc3Hi1l3rVgq9">                            <div class="row">
                            ...
                            <div class="form-group">
                                ...
                                <div class="file-upload">
                                    <label class="form-label">Attachments</label> <small
                                        class="text-danger">Max 5 files can be uploaded. Maximum upload size is                                        320M</small>
