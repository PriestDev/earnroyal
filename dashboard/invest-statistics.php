...
body.inverted video {
  filter: invert(1) hue-rotate(180deg);
    ...
    <div class="method-header mb-4">
        <p>Investment</p>
        <h3 class="method-title mb-2">All Investment</h3>
        ...
        <div class="card-body">
            <div class="investment-summary">
                <div class="summary-item">
                    <p class="summary-label">Total Invest</p>
                    <h3 class="summary-value">
                        <span class="currency">$</span>
                        <span class="amount"><?= number_format(getUserTradeCount(acct_id), 2) ?></span>
                    </h3>
                </div>
                <div class="summary-item">
                    ...
                    <h3 class="summary-value">
                        <span class="currency">$</span>
                        <span class="amount"><?= number_format(getUserTradeProfits(acct_id), 2) ?></span>
                    </h3>
                </div>
            </div>
            <div class="investment-actions">
                <a href="plan.php" class="action-btn invest-btn">
                    Invest Now <i class="fas fa-arrow-right"></i>
                </a>
                <a href="withdraw.php" class="action-btn withdraw-btn">
                    Withdraw Now <i class="fas fa-arrow-right"></i>
                </a>
            </div>
        </div>
    </div>
...
<div class="col-md-7">
    <div class="card h-100 modern-card">
        <div class="card-body">
            <div class="portfolio-empty-state">
                <?php
                if (getUserTradeCount(acct_id) <= 0) {
                    ?>
                    ...
                    <h4>No Investment Found Yet</h4>
                    <a href="plan" class="action-btn invest-btn">Start Investing</a>
                    <?php
                } else {
                    ?>
                        <div class="sub-header mb-2">
                            <h3 class="sub-title">Active Investment</h3>
                        </div>
                        <div class="investment-summary">
                            ...
                            <div class="summary-item">
                                ...
                                <div class="stat-content">
                                    ...
                                    <p class="stat-value">$<?= number_format(getUserTradeProfitPending(acct_id), 2) ?></p>
                                </div>
                            </div>
                        </div>
                    <?php
    ...
    <div class="active-investments-section">
    <div class="section-header">
        <div class="header-content">
            <h3 class="section-title">Active Investments<span class="investments-count">(<?= number_format(getUserTradeCountPending(acct_id)) ?>)</span>
            </h3>
            <a href="invest-logs.php" class="view-all-link">View All <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <div class="investments-content">
        <div class="plan-list d-flex flex-wrap flex-xxl-column gap-3 gap-xxl-0">
                <?php
                    if (getUserTradePending(acct_id) != null) {
                        ?>
                            <table class="plan-list-table col-md-12">
                                ...
                                <tbody>
                                    <?php
                                    $investments = getUserTradePending(acct_id);
...
/* If you need to style the included invest_history partial to match */
.investments-content .table {
    width: 100%;
    border-collapse: collapse;
}

.investments-content .table th {
...
.investments-content .table tr:last-child td {
    border-bottom: none;
}
...
<script src="assets/global/js/chart.min.js"></script>
