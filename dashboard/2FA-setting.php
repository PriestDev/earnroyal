...
<head>
    ...
    <title> Bluewave ISO - 2FA Setting</title>
    <meta name="title" Content="Bluewave ISO - 2FA Setting">
    ...
    <meta name="apple-mobile-web-app-title" content="Bluewave ISO - 2FA Setting">
    
    <meta itemprop="name" content="Bluewave ISO - 2FA Setting">
    ...
    <meta property="og:url" content="https://bluewave-iso.net/user/twofactor">
...
<div class="d-flex flex-wrap">
    ...
    <li>
        <a href="https://bluewave-iso.net/user/twofactor" class="active">
            <svg class="menu-icon" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div class="row justify-content-center">
            <div class=" col-md-12 ">
                <div class="method-header mb-4">
                    <h3 class="method-title mb-2">Two Factor Authentication</h3>
                ...
                <div class="row gy-4">
                        ...
                        <div class="card custom--card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group mb-3 mx-auto text-center">
                                    <img class="mx-auto" src="https://chart.googleapis.com/chart?chs=200x200&amp;chld=M|0&amp;cht=qr&amp;chl=otpauth%3A%2F%2Ftotp%2Fpriest12%40Bluewave+ISO%3Fsecret%3DTLRAQIYHBOYW7XQC">
                                </div>

                                <div class="form-group mb-3">
                                    <label class="form-label">Setup Key</label>
                                    <div class="copy-link">
                                        <input type="text" class="copyURL" value="TLRAQIYHBOYW7XQC" readonly>
                    ...
                    <div class=" col-md-6 ">
                                ...
                                <form action="https://bluewave-iso.net/user/twofactor/enable" method="POST">
                                    <div class="card-body">
                                        <input type="hidden" name="_token" value="Rl6nikVoa3o45jTzwrKb4seoP72kc3Hi1l3rVgq9">                                        <input type="hidden" name="key" value="TLRAQIYHBOYW7XQC">
                                        <div class="form-group mb-3">
