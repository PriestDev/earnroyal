...
<head>
    ...
    <title> Bluewave ISO - Schedule Invests</title>
    <meta name="title" Content="Bluewave ISO - Schedule Invests">
    ...
    <meta name="apple-mobile-web-app-title" content="Bluewave ISO - Schedule Invests">
    
    <meta itemprop="name" content="Bluewave ISO - Schedule Invests">
    ...
    <meta property="og:url" content="https://bluewave-iso.net/user/invest/schedule">
...
<div class="d-flex flex-wrap">
    ...
    <li>
        ...
        <li>
        <a href="https://bluewave-iso.net/user/invest/schedule" class="active">
            <svg class="menu-icon" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <li>
        ...
        <a href="https://bluewave-iso.net/user/crypto/portfolio" class="">
            <svg class="menu-icon" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
body.inverted video {
  filter: invert(1) hue-rotate(180deg);
        ...
        <div class="method-header mb-4">
            ...
            <h3 class="method-title mb-2">My Schedule Investment</h3>
            <p class="method-subtitle">Easily manage your scheduled investments by accessing detailed information such as upcoming investment dates, remaining investment times, and the option to enable or disable each schedule.</p>
        </div>

        <div class="investments-portfolio">
            ...
            <div class="empty-state-icon">
                <svg width="48" height="48" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <path d="M8 14C8 14 9.5 16 12 16C14.5 16 16 14 16 14" stroke="#94A3B8" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                    <path d="M9 9H9.01" stroke="#94A3B8" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                    <path d="M15 9H15.01" stroke="#94A3B8" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                </svg>
            </div>
            <h3 class="empty-state-title">Data not found</h3>
            <p class="empty-state-description">You currently have no scheduled investments</p>
        </div>
...
.investment-portfolio-card.active {
    border-top: 3px solid #10b981;
}

.investment-portfolio-card.paused {
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="" method="POST">
                <input type="hidden" name="_token" value="Rl6nikVoa3o45jTzwrKb4seoP72kc3Hi1l3rVgq9">                <div class="modal-body">
                    <p class="question"></p>
                </div>
                <div class="modal-footer">
