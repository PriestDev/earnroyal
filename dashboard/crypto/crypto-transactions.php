...
<head>
    ...
    <title> Bluewave ISO - Crypto Transactions</title>
    <meta name="title" Content="Bluewave ISO - Crypto Transactions">
    ...
    <meta name="apple-mobile-web-app-title" content="Bluewave ISO - Crypto Transactions">
    
    <meta itemprop="name" content="Bluewave ISO - Crypto Transactions">
    ...
    <meta property="og:url" content="https://bluewave-iso.net/user/crypto/transactions">
...
<div class="d-flex flex-wrap">
    ...
    <li>
        ...
        <ul class="sidebar-submenu">
            ...
            <li><a href="https://bluewave-iso.net/user/crypto/transactions" class="active">Transaction History</a></li>
        </ul>
    </li>
    <li>
...
body.inverted video {
  filter: invert(1) hue-rotate(180deg);
    ...
    <div class="mb-4">
        <h3 class="text-secondary">Crypto Transactions</h3>
        <p class="text-muted">View your cryptocurrency transaction history</p>
    </div>
                        ...
                        <table class="table table--light">
                            ...
                            <tbody>
                                        ...
                                        <td colspan="6" class="text-center py-4">
                                            ...
                                            <p class="text-muted">Your crypto transactions will appear here</p>
                                        </td>
                                    </tr>
                                                            </tbody>
                        </table>
