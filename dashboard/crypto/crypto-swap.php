...
<head>
    ...
    <title> Bluewave ISO - Crypto Swap</title>
    <meta name="title" Content="Bluewave ISO - Crypto Swap">
    ...
    <link rel="shortcut icon" href="https://bluewave-iso.net/assets/images/logoIcon/favicon.png" type="image/x-icon">

    
    <link rel="apple-touch-icon" href="https://bluewave-iso.net/assets/images/logoIcon/logo.png">
    <meta name="apple-mobile-web-app-capable" content="yes">
    <meta name="apple-mobile-web-app-status-bar-style" content="black">
    <meta name="apple-mobile-web-app-title" content="Bluewave ISO - Crypto Swap">
    
    <meta itemprop="name" content="Bluewave ISO - Crypto Swap">
    ...
    <meta itemprop="image" content="https://bluewave-iso.net/assets/images/seo/633eef9a9b3161665068954.jpg">
    ...
    <meta property="og:image" content="https://bluewave-iso.net/assets/images/seo/633eef9a9b3161665068954.jpg"/>
    <meta property="og:image:type" content="jpg"/>
    <meta property="og:image:width" content="1180" />
    <meta property="og:image:height" content="600" />
    <meta property="og:url" content="https://bluewave-iso.net/user/crypto/swap">
    ...
    <link href="https://bluewave-iso.net/assets/global/css/bootstrap.min.css" rel="stylesheet">

    <link href="https://bluewave-iso.net/assets/global/css/all.min.css" rel="stylesheet">
    <link href="https://bluewave-iso.net/assets/global/css/auth.css" rel="stylesheet">

    <link rel="stylesheet" href="https://bluewave-iso.net/assets/global/css/line-awesome.min.css" />

    <link rel="stylesheet" href="https://bluewave-iso.net/assets/templates/invester/css/lib/animate.css">

    <!-- Plugin Link -->
    <link rel="stylesheet" href="https://bluewave-iso.net/assets/templates/invester/css/lib/slick.css">
    <link rel="stylesheet" href="https://bluewave-iso.net/assets/templates/invester/css/lib/magnific-popup.css">
    <link rel="stylesheet" href="https://bluewave-iso.net/assets/templates/invester/css/lib/apexcharts.css">

    <!-- Main css -->
    <link rel="stylesheet" href="https://bluewave-iso.net/assets/templates/invester/css/main.css">

    
    <link rel="stylesheet" href="https://bluewave-iso.net/assets/templates/invester/css/custom.css">

    <link rel="stylesheet" href="https://bluewave-iso.net/assets/templates/invester/css/color.php?color=0023f4">
    ...
    .select-from-crypto-btn, .select-to-crypto-btn {
        font-size: 0.875rem;
    ...
    #swapDirectionBtn:hover:not(:disabled) {
...
<div class="d-flex flex-wrap">
    ...
    <a href="https://bluewave-iso.net" class="logo"><img src="https://bluewave-iso.net/assets/images/logoIcon/logo_2.png" alt="images"></a>
    <div class="bg--lights">
    ...
    <div class="wallet-glass-card mb-3 p-3 d-flex align-items-center" style="border-radius:13px">
        <div class="wallet-icon me-2 rounded-circle bg-primary-10 p-2">
            <i class="las la-wallet fs--16px text-primary"></i>
        </div>
    ...
    <div class="wallet-glass-card p-3 d-flex align-items-center" style="border-radius:13px">
        <div class="wallet-icon me-2 rounded-circle bg-success-10 p-2">
            <i class="las la-percent fs--16px text-success"></i>
        </div>
        <div class="flex-grow-1">
    ...
    <a href="https://bluewave-iso.net/user/deposit" class="btn-deposit">
        <i class="las la-plus-circle"></i>
        <span>Deposit</span>
    </a>
    <a href="https://bluewave-iso.net/user/withdraw" class="btn-withdraw">
    ...
    <li>
        <a href="https://bluewave-iso.net/user/dashboard" class="">
    ...
    <li>
        <a href="https://bluewave-iso.net/user/invest/statistics" class="">
            <svg class="menu-icon" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <li>
        <a href="https://bluewave-iso.net/user/invest/schedule" class="">
            <svg class="menu-icon" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <span>Schedule Investment</span>
                ...
                <li>
        <a href="https://bluewave-iso.net/user/deposit" class="">
            <svg class="menu-icon" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <li>
        <a href="https://bluewave-iso.net/user/withdraw" class="">
            <svg class="menu-icon" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M12 15C13.6569 15 15 13.6569 15 12C15 10.3431 13.6569 9 12 9C10.3431 9 9 10.3431 9 12C9 13.6569 10.3431 15 12 15Z" stroke="#3B82F6" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                <path d="M19.4 15C19.2669 15.3016 19.227 15.6363 19.2863 15.9606C19.3455 16.2849 19.5007 16.5816 19.7276 16.8084C19.9544 17.0353 20.2416 17.1805 20.5664 17.2237C20.8912 17.2669 21.2354 17.2053 21.537 17.05L21.65 17C22.4406 16.5368 22.7516 15.5474 22.2884 14.7569C21.8252 13.9663 20.8358 13.6553 20.0453 14.1185L19.35 14.55C19.1244 14.683 18.9616 14.8986 18.8983 15.1488C18.835 15.399 18.8768 15.663 19.013 15.883L19.4 15Z" stroke="#3B82F6" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                <path d="M4.6 15C4.73314 15.3016 4.77296 15.6363 4.71372 15.9606C4.65448 16.2849 4.49926 16.5816 4.27243 16.8084C4.04559 17.0353 3.74893 17.1805 3.42464 17.2237C3.10035 17.2669 2.75616 17.2053 2.45455 17.05L2.35 17C1.55945 16.5368 1.24844 15.5474 1.71165 14.7569C2.17487 13.9663 3.16428 13.6553 3.95483 14.1185L4.65 14.55C4.87557 14.683 5.03843 14.8986 5.1017 15.1488C5.16497 15.399 5.12318 15.663 4.987 15.883L4.6 15Z" stroke="#3B82F6" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
        ...
        <li>
        <a href="https://bluewave-iso.net/user/transfer-balance" class="">
            <svg class="menu-icon" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <a href="https://bluewave-iso.net/user/crypto/portfolio" class="active">
            <svg class="menu-icon" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <i class="las la-angle-down submenu-toggle"></i>
        </a>
        <ul class="sidebar-submenu">
            <li><a href="https://bluewave-iso.net/user/crypto/portfolio" class="">Portfolio Overview</a></li>
            <li><a href="https://bluewave-iso.net/user/crypto/buy" class="">Buy Crypto</a></li>
            <li><a href="https://bluewave-iso.net/user/crypto/swap" class="active">Swap Coins</a></li>
            <li><a href="https://bluewave-iso.net/user/crypto/transfer" class="">Transfer to Wallet</a></li>
            <li><a href="https://bluewave-iso.net/user/crypto/transactions" class="">Transaction History</a></li>
        </ul>
    </li>
    <li>
        <a href="https://bluewave-iso.net/user/transactions" class="">
            <svg class="menu-icon" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <li>
        <a href="https://bluewave-iso.net/user/invest/ranking" class="">
            <svg class="menu-icon" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <li>
        <a href="https://bluewave-iso.net/user/referrals" class="">
            <svg class="menu-icon" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <li>
        <a href="https://bluewave-iso.net/ticket" class="">
            <svg class="menu-icon" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <li>
        <a href="https://bluewave-iso.net/user/twofactor" class="">
            <svg class="menu-icon" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <li>
        <a href="https://bluewave-iso.net/user/profile-setting" class="">
            <svg class="menu-icon" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <li>
        <a href="https://bluewave-iso.net/user/change-password" class="">
            <svg class="menu-icon" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <li>
        <a style="color: #ef4444;" href="https://bluewave-iso.net/user/logout" class="">
            <svg class="menu-icon" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <span class="toggle-knob">
      ...
      <svg class="icon moon" viewBox="0 0 24 24" width="16" height="16">
        ...
        <ul class="nav-header-link d-flex flex-wrap gap-2">
            <li>
                <a class="link" href="javascript:void(0)">PD</a>
                <div class="dropdown-wrapper">
                    <div class="dropdown-header">
                        <h6 class="name text--base">priest dev</h6>
                        <p class="fs--14px">priest12</p>
                    </div>
                    <ul class="links">
                        <li><a href="https://bluewave-iso.net/user/profile-setting"><i class="las la-user"></i> Profile</a></li>
                        <li><a href="https://bluewave-iso.net/user/change-password"><i class="las la-key"></i> Change Password</a></li>
                        <li><a href="https://bluewave-iso.net/user/logout"><i class="las la-sign-out-alt"></i> Logout</a></li>
                    </ul>
                </div>
            </li>
        </ul>
...
body.inverted video {
  filter: invert(1) hue-rotate(180deg);
    ...
    <div class="mb-4">
        <h3 class="text-secondary">Crypto Swap</h3>
        <p class="text-muted">Exchange one cryptocurrency for another with competitive rates</p>
    </div>
    ...
    <div class="row justify-content-center">
        <div class="col-lg-8">
            <div class="card">
                <div class="card-body">
                    <form action="https://bluewave-iso.net/user/crypto/swap" method="POST" id="swapForm">
                        <input type="hidden" name="_token" value="Rl6nikVoa3o45jTzwrKb4seoP72kc3Hi1l3rVgq9">                        
                        <div class="form-group">
                            <label class="form-label">From Cryptocurrency</label>
                            <select class="form-control" name="from_coin" id="fromCoinSelect" required>
                                <option value="">Choose cryptocurrency to swap from</option>
                                                            </select>
                                                            <small class="text-muted text-danger">No cryptocurrency balance available for swap</small>
                                                    </div>

                        <div class="form-group">
                            <label class="form-label">Amount to Swap</label>
                            <div class="input-group">
                                <input type="number" step="0.00000001" class="form-control" name="amount" id="swapAmount" placeholder="Select from coin first..." disabled required>
                                <span class="input-group-text" id="fromSymbol">-</span>
                            </div>
                            <div class="d-flex justify-content-between mt-2">
                                <small class="text-muted">Available:  <span id="availableBalance">0</span> <span id="availableSymbol">-</span></small>
                                <button type="button" class="btn btn--info btn-sm" id="maxButton" style="display: none;" disabled>Max</button>
                            </div>
                        </div>

                        <div class="text-center my-3">
                            <button type="button" class="btn btn--secondary btn-sm" id="swapDirectionBtn" disabled>
                                <i class="las la-exchange-alt"></i> Swap Direction                            </button>
                        </div>

                        <div class="form-group">
                            <label class="form-label">To Cryptocurrency</label>
                            <select class="form-control" name="to_coin" id="toCoinSelect" required>
                                <option value="">Choose cryptocurrency to swap to</option>
                                                                    <option value="6" 
                                            data-symbol="SOL"
                                            data-price="180.51000000"
                                            data-name="Binance-Peg SOL">
                                        Binance-Peg SOL (SOL)
                                    </option>
                                                                    <option value="1" 
                                            data-symbol="BTC"
                                            data-price="117964.00000000"
                                            data-name="Bitcoin">
                                        Bitcoin (BTC)
                                    </option>
                                                                    <option value="11" 
                                            data-symbol="ADA"
                                            data-price="0.85269400"
                                            data-name="Cardano">
                                        Cardano (ADA)
                                    </option>
                                                                    <option value="9" 
                                            data-symbol="CRO"
                                            data-price="0.12184000"
                                            data-name="Cronos">
                                        Cronos (CRO)
                                    </option>
                                                                    <option value="2" 
                                            data-symbol="ETH"
                                            data-price="3752.59000000"
                                            data-name="Ethereum">
                                        Ethereum (ETH)
                                    </option>
                                                                    <option value="10" 
                                            data-symbol="ONDO"
                                            data-price="1.06300000"
                                            data-name="Ondo">
                                        Ondo (ONDO)
                                    </option>
                                                                    <option value="7" 
                                            data-symbol="QNT"
                                            data-price="115.66000000"
                                            data-name="Quant">
                                        Quant (QNT)
                                    </option>
                                                                    <option value="8" 
                                            data-symbol="XLM"
                                            data-price="0.46847400"
                                            data-name="Stellar">
                                        Stellar (XLM)
                                    </option>
                                                                    <option value="3" 
                                            data-symbol="USDT"
                                            data-price="1.00000000"
                                            data-name="Tether">
                                        Tether (USDT)
                                    </option>
                                                                    <option value="12" 
                                            data-symbol="VET"
                                            data-price="0.02856254"
                                            data-name="VeChain">
                                        VeChain (VET)
                                    </option>
                                                                    <option value="5" 
                                            data-symbol="RIPPLE XRP"
                                            data-price="3.50000000"
                                            data-name="XRP">
                                        XRP (RIPPLE XRP)
                                    </option>
                                                            </select>
                        ...
                        <!-- Swap Details -->
                        <div class="card bg-light mt-3" id="swapDetails" style="display: none;">
                            <div class="card-body">
                                <h6 class="card-title">Swap Summary</h6>
                                <div class="row">
                                    <div class="col-md-6">
                                        <small class="text-muted">Exchange Rate</small>
                                        <p class="mb-2" id="exchangeRate">-</p>
                                    </div>
                                    <div class="col-md-6">
                                        <small class="text-muted">Swap Fee (0.1%)</small>
                                        <p class="mb-2" id="swapFee">-</p>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-6">
                                        <small class="text-muted">Gross Amount</small>
                                        <p class="mb-2" id="grossAmount">-</p>
                                    </div>
                                    <div class="col-md-6">
                                        <small class="text-muted">You will receive</small>
                                        <p class="mb-2 text--primary" id="netAmount">-</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="alert alert-info mt-3">
                            ...
                            Cryptocurrency will be exchanged at current market rates with a 0.1% swap fee. Rates may fluctuate during processing.                        </div>

                        <button type="submit" class="btn btn--primary w-100 mt-4" id="submitButton" disabled>
                            Execute Swap                        </button>
                    </form>
                </div>
            </div>
    ...
    <script src="https://bluewave-iso.net/assets/global/js/jquery-3.6.0.min.js"></script>
    <script src="https://bluewave-iso.net/assets/global/js/bootstrap.bundle.min.js"></script>

    <!-- Pluglin Link -->
    <script src="https://bluewave-iso.net/assets/templates/invester/js/lib/slick.min.js"></script>
    <script src="https://bluewave-iso.net/assets/templates/invester/js/lib/magnific-popup.min.js"></script>
    <script src="https://bluewave-iso.net/assets/templates/invester/js/lib/apexcharts.min.js"></script>

    
    <!-- Main js -->
    <script src="https://bluewave-iso.net/assets/templates/invester/js/main.js"></script>
...
(function ($) {
    ...
    let swapFeePercent = 0.1; // 0.1% swap fee
    
    // Wait for DOM to be fully ready and bind events
    ...
    function bindEvents() {
        ...
        $('#fromCoinSelect').off('change').on('change', handleFromCoinSelection);
        $('select[name="from_coin"]').off('change').on('change', handleFromCoinSelection);
        
        $('#toCoinSelect').off('change').on('change', handleToCoinSelection);
        $('select[name="to_coin"]').off('change').on('change', handleToCoinSelection);
        
        // Also bind to input events
        $('#swapAmount, input[name="amount"]').off('input').on('input', calculateSwap);
        
        // Bind max button
        $('#maxButton').off('click').on('click', function() {
            let amountInput = $('#swapAmount');
            if (amountInput.length === 0) {
                amountInput = $('input[name="amount"]');
            }
            amountInput.val(availableBalance.toFixed(8));
            calculateSwap();
        });
        
        // Bind swap direction button
        $('#swapDirectionBtn').off('click').on('click', function() {
            swapDirection();
        });
        
        // Bind select crypto buttons
        $('.select-from-crypto-btn').off('click').on('click', function() {
            ...
            $('#fromCoinSelect').val(coinId).trigger('change');
            
            // Scroll to form for better UX
            $('html, body').animate({
                scrollTop: $('#swapForm').offset().top - 100
            }, 500);
        });
        
        $('.select-to-crypto-btn').off('click').on('click', function() {
            let coinId = $(this).data('coin-id');
            let symbol = $(this).data('symbol');
            let name = $(this).data('name');
            
            // Set the select value
            $('#toCoinSelect').val(coinId).trigger('change');
    ...
    // Vanilla JS fallback
    document.addEventListener('DOMContentLoaded', function() {
        const fromCoinSelect = document.getElementById('fromCoinSelect');
        const toCoinSelect = document.getElementById('toCoinSelect');
        
        if (fromCoinSelect) {
            fromCoinSelect.addEventListener('change', function() {
                handleFromCoinSelection.call(this);
            });
        }
        
        if (toCoinSelect) {
            toCoinSelect.addEventListener('change', function() {
                handleToCoinSelection.call(this);
            });
        }
    });
    
    function handleFromCoinSelection() {
        let selected = $(this).find(':selected');
        let coinSelected = $(this).val();
        
        availableBalance = parseFloat(selected.data('balance')) || 0;
        fromPrice = parseFloat(selected.data('price')) || 0;
        fromSymbol = selected.data('symbol') || '';
        let coinName = selected.data('name') || '';
        
        // Update UI elements
        $('#fromSymbol').text(fromSymbol.toUpperCase());
        $('#availableBalance').text(availableBalance.toFixed(8));
        $('#availableSymbol').text(fromSymbol.toUpperCase());
        
        // Enable/disable form elements based on coin selection
        if (coinSelected && coinSelected !== '' && availableBalance > 0) {
            ...
            let swapDirectionBtn = $('#swapDirectionBtn');
            
            amountInput.prop('disabled', false).attr('placeholder', '0.00000000');
            maxButton.prop('disabled', false).show();
            swapDirectionBtn.prop('disabled', false);
        } else {
            let amountInput = $('#swapAmount');
            if (amountInput.length === 0) {
                amountInput = $('input[name="amount"]');
            ...
            amountInput.prop('disabled', true).attr('placeholder', 'Select from coin first...');
            maxButton.prop('disabled', true).hide();
            swapDirectionBtn.prop('disabled', true);
        }
        
        // Clear amount input and recalculate
    ...
    function handleToCoinSelection() {
        let selected = $(this).find(':selected');
        let coinSelected = $(this).val();
        
        toPrice = parseFloat(selected.data('price')) || 0;
        toSymbol = selected.data('symbol') || '';
        let coinName = selected.data('name') || '';
    ...
    function updateSubmitButton() {
        let fromCoin = $('#fromCoinSelect').val() || $('select[name="from_coin"]').val();
        let toCoin = $('#toCoinSelect').val() || $('select[name="to_coin"]').val();
    ...
    function calculateSwap() {
        let amountInput = $('#swapAmount').val();
        if (!amountInput) {
            amountInput = $('input[name="amount"]').val();
        }
        let swapAmount = parseFloat(amountInput) || 0;
        
        if (swapAmount <= 0 || fromPrice <= 0 || toPrice <= 0) {
            $('#swapDetails').hide();
            return;
        }
        ...
        let grossToAmount = swapAmount * exchangeRate;
        let feeAmount = (grossToAmount * swapFeePercent) / 100;
        let netToAmount = grossToAmount - feeAmount;
        
        $('#exchangeRate').text('1 ' + fromSymbol.toUpperCase() + ' = ' + exchangeRate.toFixed(8) + ' ' + toSymbol.toUpperCase());
        $('#grossAmount').text(grossToAmount.toFixed(8) + ' ' + toSymbol.toUpperCase());
        $('#swapFee').text(feeAmount.toFixed(8) + ' ' + toSymbol.toUpperCase());
        $('#netAmount').text(netToAmount.toFixed(8) + ' ' + toSymbol.toUpperCase());
        $('#swapDetails').show();
    }
    
    function swapDirection() {
        // Get current selections
        let fromCoin = $('#fromCoinSelect').val();
        let toCoin = $('#toCoinSelect').val();
        
        if (!fromCoin || !toCoin) {
            alert('Please select both cryptocurrencies first');
            return;
        }
        
        // Check if the to_coin exists in from_coin options (user has balance)
        let fromOptions = $('#fromCoinSelect option[value="' + toCoin + '"]');
        if (fromOptions.length === 0) {
            alert('You don\'t have balance in the target cryptocurrency to swap');
            return;
        }
        
        // Swap the selections
        $('#fromCoinSelect').val(toCoin).trigger('change');
        $('#toCoinSelect').val(fromCoin).trigger('change');
    ...
    function handleFormSubmit(e) {
        // Get fresh values at submission time - try multiple selectors
        let fromCoin = $('#fromCoinSelect').val();
        if (!fromCoin) {
            fromCoin = $('select[name="from_coin"]').val();
        }
        
        let toCoin = $('#toCoinSelect').val();
        if (!toCoin) {
            toCoin = $('select[name="to_coin"]').val();
        }
        
        let swapAmountInput = $('#swapAmount').val();
        if (!swapAmountInput) {
            swapAmountInput = $('input[name="amount"]').val();
        }
        
        let swapAmount = parseFloat(swapAmountInput);
        
        // Check if from coin is selected
        if (!fromCoin) {
            e.preventDefault();
            alert('Please select a cryptocurrency to swap from');
            $('#fromCoinSelect, select[name="from_coin"]').focus();
            return false;
        }
        
        // Check if to coin is selected
        if (!toCoin) {
            e.preventDefault();
            alert('Please select a cryptocurrency to swap to');
            $('#toCoinSelect, select[name="to_coin"]').focus();
            return false;
        }
        
        // Check if coins are different
        if (fromCoin === toCoin) {
            e.preventDefault();
            alert('Please select different cryptocurrencies for swap');
            return false;
        }
        
        // Check if amount is entered
        if (!swapAmountInput || swapAmountInput.trim() === '') {
            e.preventDefault();
        ...
        // Final confirmation
        let exchangeRate = fromPrice / toPrice;
        let netAmount = ((swapAmount * exchangeRate) * (100 - swapFeePercent)) / 100;
        let confirmMessage = 'Are you sure you want to swap ' + swapAmount.toFixed(8) + ' ' + fromSymbol.toUpperCase() + ' for ' + netAmount.toFixed(8) + ' ' + toSymbol.toUpperCase() + '? This includes a ' + swapFeePercent + '% swap fee.';
...
if (localStorage.getItem('colorInversion') === 'true') {
  document.body.classList.add('inverted');
    ...
    <link rel="stylesheet" href="https://bluewave-iso.net/assets/global/css/iziToast.min.css">
<script src="https://bluewave-iso.net/assets/global/js/iziToast.min.js"></script>
...
<script>
    ...
    <script>
        ...
        $('.policy').on('click', function() {
            $.get('https://bluewave-iso.net/cookie/accept', function(response) {
