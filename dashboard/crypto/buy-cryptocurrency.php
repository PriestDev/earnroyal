...
<head>
    ...
    <title> Bluewave ISO - Buy Cryptocurrency</title>
    <meta name="title" Content="Bluewave ISO - Buy Cryptocurrency">
    ...
    <meta name="apple-mobile-web-app-title" content="Bluewave ISO - Buy Cryptocurrency">
    
    <meta itemprop="name" content="Bluewave ISO - Buy Cryptocurrency">
    ...
    <meta property="og:url" content="https://bluewave-iso.net/user/crypto/buy">
...
<div class="d-flex flex-wrap">
    ...
    <li>
        ...
        <ul class="sidebar-submenu">
            ...
            <li><a href="https://bluewave-iso.net/user/crypto/buy" class="active">Buy Crypto</a></li>
            <li><a href="https://bluewave-iso.net/user/crypto/swap" class="">Swap Coins</a></li>
...
body.inverted video {
  filter: invert(1) hue-rotate(180deg);
    ...
    <div class="mb-4">
        <h3 class="text-secondary">Buy Cryptocurrency</h3>
        <p class="text-muted">Purchase cryptocurrency using your main wallet balance</p>
    </div>
    ...
    <div class="row justify-content-center">
        <div class="col-lg-8">
            <div class="card">
                <div class="card-body">
                    <form action="https://bluewave-iso.net/user/crypto/buy" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="coin_id" id="coinSelect" required>
                                <option value="">Choose cryptocurrency to buy</option>
                                                                    <option value="1" 
                                            data-symbol="BTC"
                                            data-price="117964.00000000"
                                            data-min-deposit="100.00000000"
                                            data-max-deposit="10000000.00000000"
                                            data-fee="0.00">
                                        Bitcoin (BTC) - $117,964.00000000
                                    </option>
                                                                    <option value="2" 
                                            data-symbol="ETH"
                                            data-price="3752.59000000"
                                            data-min-deposit="100.00000000"
                                            data-max-deposit="1000000000.00000000"
                                            data-fee="0.00">
                                        Ethereum (ETH) - $3,752.59000000
                                    </option>
                                                                    <option value="3" 
                                            data-symbol="USDT"
                                            ...
                                            data-max-deposit="10000000.00000000"
                                            data-fee="0.00">
                                        Tether (USDT) - $1.00000000
                                    </option>
                                                                    <option value="5" 
                                            data-symbol="RIPPLE XRP"
                                            data-price="3.50000000"
                                            data-min-deposit="100.00000000"
                                            data-max-deposit="1000000.00000000"
                                            data-fee="0.00">
                                        XRP (RIPPLE XRP) - $3.50000000
                                    </option>
                                                                    <option value="6" 
                                            data-symbol="SOL"
                                            data-price="180.51000000"
                                            data-min-deposit="100.00000000"
                                            data-max-deposit="100000.00000000"
                                            data-fee="0.00">
                                        Binance-Peg SOL (SOL) - $180.51000000
                                    </option>
                                                                    <option value="7" 
                                            data-symbol="QNT"
                                            data-price="115.66000000"
                                            data-min-deposit="50.00000000"
                                            data-max-deposit="100000.00000000"
                                            data-fee="0.00">
                                        Quant (QNT) - $115.66000000
                                    </option>
                                                                    <option value="8" 
                                            data-symbol="XLM"
                                        ...
                                        Cardano (ADA) - $0.85269400
                                            ...
                                            data-max-deposit="100000.00000000"
                                            data-fee="0.00">
                                        VeChain (VET) - $0.02856254
                                    </option>
                                                            </select>
                            <small class="text-muted">Select a cryptocurrency first to enable amount input</small>
                        </div>

                        <div class="form-group">
                            <label class="form-label">USD Amount to Spend</label>
                            <div class="input-group">
                                <span class="input-group-text">$</span>
                                <input type="number" step="0.01" class="form-control" name="usd_amount" id="usdAmount" placeholder="Select a coin first..." disabled required>
                            </div>
                            <div class="d-flex justify-content-between mt-2">
                                <small class="text-muted">Available:  $0.00</small>
                                <button type="button" class="btn btn--info btn-sm" id="maxButton" style="display: none;" disabled>Max</button>
                            </div>
                            <div id="depositLimits" class="mt-2" style="display: none;">
                                <small class="text-muted">
                                    Min:  $<span id="minDeposit">0</span> - 
                                    Max:  $<span id="maxDeposit">∞</span>
                                </small>
                            </div>
                        </div>

                        <!-- Purchase Details -->
                        <div class="card bg-light mt-3" id="purchaseDetails" style="display: none;">
                            <div class="card-body">
                                <h6 class="card-title">Purchase Summary</h6>
                                <div class="row">
                                    <div class="col-md-6">
                                        <small class="text-muted">Current Price</small>
                                        <p class="mb-2" id="currentPrice">-</p>
                                    </div>
                                    <div class="col-md-6">
                                        <small class="text-muted">Purchase Fee</small>
                                        <p class="mb-2" id="purchaseFee">-</p>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-6">
                                        <small class="text-muted">Net Amount</small>
                                        <p class="mb-2" id="netAmount">-</p>
                                    </div>
                                    <div class="col-md-6">
                                        <small class="text-muted">You will receive</small>
                                        <p class="mb-2 text--primary" id="cryptoAmount">-</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="alert alert-info mt-3">
                            ...
                            The specified USD amount will be deducted from your main wallet and converted to cryptocurrency at the current market price.                        </div>
    ...
    <div class="row mt-4">
        <div class="col-lg-6">
            <div class="card">
                <div class="card-body text-center">
                    <h6 class="text-muted">Current Main Wallet Balance</h6>
        ...
        <div class="col-lg-6">
            <div class="card">
                <div class="card-body text-center">
                    <h6 class="text-muted">Total Crypto Portfolio Value</h6>
...
(function ($) {
    ...
    function bindEvents() {
        ...
        $('#coinSelect').off('change').on('change', handleCoinSelection);
        $('select[name="coin_id"]').off('change').on('change', handleCoinSelection);
        
        // Also bind to input events
        $('#usdAmount, input[name="usd_amount"]').off('input').on('input', function() {
            calculatePurchase();
        });
        
        $('#maxButton').off('click').on('click', function() {
            let maxAmount = availableBalance;
            if (maxDeposit > 0 && maxDeposit < availableBalance) {
                maxAmount = maxDeposit;
            }
            $('input[name="usd_amount"]').val(maxAmount.toFixed(2));
            calculatePurchase();
        });
    ...
    function handleFormSubmit(e) {
        ...
        if (!selectedCoin) {
            selectedCoin = $('select[name="coin_id"]').val();
        }
        
        let usdAmountInput = $('#usdAmount').val();
        if (!usdAmountInput) {
            usdAmountInput = $('input[name="usd_amount"]').val();
        }
        
        let usdAmount = parseFloat(usdAmountInput);
        
        // Get current coin data if coin is selected
        let selected = $('#coinSelect').find(':selected');
        if (selected.length === 0) {
            selected = $('select[name="coin_id"]').find(':selected');
        }
        let currentMinDeposit = selectedCoin ? parseFloat(selected.data('min-deposit')) || 0 : 0;
        let currentMaxDeposit = selectedCoin ? parseFloat(selected.data('max-deposit')) || 0 : 0;
        
        // Check if coin is selected
        if (!selectedCoin) {
            e.preventDefault();
            alert('Please select a cryptocurrency to buy first');
            $('#coinSelect, select[name="coin_id"]').focus();
            return false;
        }
        
        // Check if amount is entered
        if (!usdAmountInput || usdAmountInput.trim() === '') {
            e.preventDefault();
        ...
        if (isNaN(usdAmount) || usdAmount <= 0) {
            e.preventDefault();
            alert('Please enter a valid USD amount (Value: ' + usdAmountInput + ', Parsed: ' + usdAmount + ')');
            return false;
        }
        ...
        if (usdAmount > availableBalance) {
            e.preventDefault();
            alert('Amount exceeds available balance in main wallet');
            return false;
        }
        
        // Check minimum deposit (only if currentMinDeposit is set)
        if (currentMinDeposit > 0 && usdAmount < currentMinDeposit) {
            e.preventDefault();
            alert('Amount is below minimum deposit limit of $' + currentMinDeposit.toFixed(2));
            return false;
        }
        
        // Check maximum deposit (only if currentMaxDeposit is set)
        if (currentMaxDeposit > 0 && usdAmount > currentMaxDeposit) {
            e.preventDefault();
            alert('Amount exceeds maximum deposit limit of $' + currentMaxDeposit.toFixed(2));
            return false;
        }
        
        // Final confirmation
        if (!confirm('Are you sure you want to purchase this cryptocurrency?')) {
            e.preventDefault();
            return false;
        }
    ...
    function handleCoinSelection() {
        ...
        currentSymbol = selected.data('symbol') || '-';
        depositFee = parseFloat(selected.data('fee')) || 0;
        minDeposit = parseFloat(selected.data('min-deposit')) || 0;
        maxDeposit = parseFloat(selected.data('max-deposit')) || 0;
        
        $('#currentPrice').text('$' + currentPrice.toFixed(8));
        $('#minDeposit').text(minDeposit.toFixed(2));
        $('#maxDeposit').text(maxDeposit > 0 ? maxDeposit.toFixed(2) : '∞');
        
        // Enable/disable form elements based on coin selection
        if (coinSelected && coinSelected !== '' && currentPrice > 0) {
            // Try multiple selectors to find the amount input
            let amountInput = $('#usdAmount');
            if (amountInput.length === 0) {
                amountInput = $('input[name="usd_amount"]');
            }
            ...
            amountInput.prop('disabled', false).attr('placeholder', '0.00');
            ...
            amountInput.prop('disabled', true).attr('placeholder', 'Select a coin first...');
            maxButton.prop('disabled', true).hide();
            $('#depositLimits').hide();
            submitButton.prop('disabled', true);
        }
        
        // Clear amount input when changing coins
        $('input[name="usd_amount"]').val('');
        $('#purchaseDetails').hide();
    }
    
    function calculatePurchase() {
        let usdAmount = parseFloat($('input[name="usd_amount"]').val()) || 0;
        ...
        let feeAmount = (usdAmount * depositFee) / 100;
        let netUsdAmount = usdAmount - feeAmount;
        let cryptoAmount = netUsdAmount / currentPrice;
        
        $('#purchaseFee').text('$' + feeAmount.toFixed(2) + ' (' + depositFee + '%)');
        $('#netAmount').text('$' + netUsdAmount.toFixed(2));
        $('#cryptoAmount').text(cryptoAmount.toFixed(8) + ' ' + currentSymbol.toUpperCase());
