...
<head>
    ...
    <title> Bluewave ISO - User Ranking</title>
    <meta name="title" Content="Bluewave ISO - User Ranking">
    ...
    <meta name="apple-mobile-web-app-title" content="Bluewave ISO - User Ranking">
    
    <meta itemprop="name" content="Bluewave ISO - User Ranking">
    ...
    <meta property="og:url" content="https://bluewave-iso.net/user/invest/ranking">
...
<div class="d-flex flex-wrap">
    ...
    <li>
        ...
        <li>
        <a href="https://bluewave-iso.net/user/invest/ranking" class="active">
            <svg class="menu-icon" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
body.inverted video {
  filter: invert(1) hue-rotate(180deg);
        ...
        <div class="method-header mb-4">
            <p>Invest Rankings</p>
            <h3 class="method-title mb-2">Invest Rankings List</h3>
        </div>
        <hr>
